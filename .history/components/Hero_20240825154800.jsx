...
const Hero = () => {
  ...
  useEffect(() => {
    setIsClient(true); // This will trigger a re-render once the component is mounted on the client
    ...
    if (typeof window !== 'undefined') {
      ...
      const handleResize = debounce(() => {
        if (scroll && typeof scroll.update === 'function') {
          ...
          console.error("scroll.update is not a function or scroll is not initialized properly.", scroll);
        }
      }, 100);
  ...
  if (!isClient) return null; // This prevents SSR from rendering this component
