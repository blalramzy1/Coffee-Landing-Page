            ...
            return (
              <SwiperSlide className='w-full h-full' key={index}>
                <div className='flex justify-center h-full lg:pt-14'>
                  <div className='max-w-[60%] text-primary text-center'>
                    <IoMdQuote className='text-6xl text-primary mb-12 mx-auto'/>
                    <p className='text-2xl font-secondry text-center mb-8'>{person.message}</p>
                    <div className='text-center'>
                      <p className=' text-xl font-bold mb-1'>{person.name}</p>
                      <p className=' text-secondry'>{person.profession}</p>
                    </div>
                  </div>
                </div>
              </SwiperSlide>
